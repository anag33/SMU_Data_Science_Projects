...
function makeMap(fullURL, minMag) {
    ...
    d3.json(fullURL).then(function(response) {
        ...
        //create master layer - markers and heatmap
        ...
        d3.json(tectonicPlatesURL).then(function(plates) {
            ...
            // Create a baseMaps object - contains streetmap and darkmap
            var baseMaps = {
                "Street": streetmap,
                "Dark": darkmap,
                "Light": lightmap,
            ...
            // Create an overlayMaps object - state and city population layer
            var overlayMaps = {
                "Heatmap": heat,
                "Markers": markers,
                "Circles": circleLayer,
